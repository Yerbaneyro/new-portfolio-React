    ...
    <div className="container" data-theme={props.theme}>
        ...
        <div className='center-screen'>
            ...
            <div className='opacity'>
                <a href='https://github.com/Yerbaneyro/React-Flask-Face-App' target='_blank'><button className='github-button'>GitHub <FaGithub className='button-icon'/></button></a>
                <a href='https://awesome-saha-454f9c.netlify.app/' target='_blank'><button className='demo-button'>DEMO</button></a>
            </div>
            ...
            <div id="project-description">
                ...
                <a href='https://awesome-saha-454f9c.netlify.app/' target='_blank' className={'face-page-link'}>Click here to see DEMO</a>
            </div>
        </div>
        <div className='this-center'>
            <img src={FaceThumbal} alt='portfolio-screenshot'  className='screenshot' />
