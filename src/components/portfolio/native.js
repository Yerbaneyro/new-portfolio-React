...
import { SiJavascript, SiGraphql, SiApollographql, SiTypescript, SiGit } from 'react-icons/si'
...
return(
    ...
    <div className="container" data-theme={props.theme}>
        ...
        <div className='this-center'>
            <img src={appThumbal} alt='portfolio-screenshot'  className='app-thumbal' />
            ...
            <p className='description'>Mobile app created with React Native. Users can communicate with other users. Data is held by the server using GraphQL. Connection to the database is live with help of Apollo Client. In the coming future, I plan to implement Sign Up/Log In feature. To run an app on your device you should use Expo Go. Created in Jan 2022 </p>
            ...
            <div className='links'>
                ...
                <div className='links-icons'>
                    <a href='https://github.com/Yerbaneyro/chatty-app' target='_blank'><FaGithub /></a>
                </div>
            </div>
        </div> 
    </div>
